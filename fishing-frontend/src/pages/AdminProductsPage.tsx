                ...
                <td className="px-4 py-3">
                  <div className="flex justify-end gap-3">
                    ...
                    <button
                      ...
                      className={
                        p.stockQuantity > 0
                          ? 'rounded-lg border border-white/10 bg-white/5 px-3.5 py-2 text-sm font-semibold text-slate-500'
                          : 'rounded-lg border border-red-500/30 bg-red-500/10 px-3.5 py-2 text-sm font-semibold text-red-100 shadow-sm shadow-black/20 transition hover:bg-red-500/15 hover:border-red-400/50'
                      }
      ...
      {open && (
        <div className="fixed inset-0 z-[70]">
          <button
            ...
            aria-label="Close"
          />
          <div className="absolute left-1/2 top-1/2 w-[min(760px,calc(100%-2rem))] max-h-[calc(100vh-4rem)] -translate-x-1/2 -translate-y-1/2 overflow-auto rounded-3xl border border-white/10 bg-surface-900/95 p-6 shadow-2xl shadow-black/60 sm:p-8">
